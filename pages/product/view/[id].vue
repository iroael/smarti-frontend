...
const bundleStats = computed(() => {
  ...
  const totalValue = product.value.bundleItems.reduce((sum, item) => {
    return sum + (item.quantity * parseFloat(item.product.prices?.[0]?.dpp_jual || '0'))
  }, 0)
        ...
        <CardContent>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p class="text-sm text-blue-600 font-medium">Harga Beli (DPP)</p>
            ...
            <div class="text-center p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p class="text-sm text-green-600 font-medium">Harga Jual (DPP)</p>
            ...
            <div class="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <p class="text-sm text-purple-600 font-medium">Harga Jual B</p>
            ...
            <table class="w-full border-collapse">
              <thead>
                <tr class="border-b-2 border-muted">
                  ...
                  <th class="text-right py-3 px-4 font-semibold text-muted-foreground">Harga Satuan</th>
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="py-4 px-4 text-right font-bold">
                    {{ formatCurrency(item.quantity * parseFloat(item.product.prices?.[0]?.dpp_jual || '0')) }}
                  </td>
                </tr>
              </tbody>
            </table>
