...
<template>
  <div class="p-6">
    ...
    <div v-else class="space-y-6">
      ...
      <Card>
        <CardHeader class="pb-4">
          <CardTitle class="text-lg">Catatan Tambahan</CardTitle>
        </CardHeader>
        <CardContent>
          <div class="space-y-2">
            <Label for="notes" class="text-sm font-medium">
              Catatan untuk Order (Opsional)
            </Label>
            <Textarea
              id="notes"
              v-model="notes"
            ...
            <p class="text-xs text-gray-500">
              Catatan ini akan disertakan dalam sales order dan dapat dilihat oleh tim pengiriman
            </p>
          </div>
        </CardContent>
      </Card>
